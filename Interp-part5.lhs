...
> runS env s = do 
>                 menv <- newMVar env
>                 let taut = findTautologies s
>                 case taut of
>                   Just err -> System.putStrLn $ "Tautology in code: " ++ err
>                   Nothing -> do
...
> findTautologies :: Statement -> Maybe String
> findTautologies (Seq s0 s1) = case (findTautologies s0) of
>                                   Just err -> Just err
>                                   Nothing -> findTautologies s1
> findTautologies (If e _ _) = fte e    
> findTautologies (While e _) = fte e
> findTautologies _ = Nothing
